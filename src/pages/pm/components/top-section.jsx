...
function TopSection() {
  ...
  return (
    <section id="home" className="w-full text-white flex items-center justify-center  sm:px-6 px-5 lg:px-[135px]">
      <div className="w-full flex-wrap-top flex flex-col gap-[0px] lg:flex-row items-center justify-between gap-[20px]">
        {/* LEFT SIDE */}
        <motion.div
          className="relative lg:block  z-20"
        ...
        >
          <div className="space-y-4 ">
            ...
            <h1 className="md:w-[600px] w-full text-4xl md:text-5xl font-light leading-tight playfair-display-uniquifier">
              ...
              Property Management Business with Qualified Homeowner Leads.
            </h1>

            {/* Subheading */}
            <p className="text-white max-w-[607px] text-lg ">

              Join the nation’s largest vacation rental property manager marketplace free to sign up, <span className="font-bold"> pay only when you win</span>
            </p>
